...
function watchFiles() {
  gulp.watch(
    ["src/pages/*.html", "src/blocks/**/*.html"],
    gulp.series(html, reload),
  );
  gulp.watch(
    ["src/styles/**/*.scss", "src/blocks/**/*.scss"],
...
const build = gulp.series(
  clean,
  gulp.parallel(html, styles, copyVendors, script, images, fonts),
);

// dev
const dev = gulp.series(build, runServer, watchFiles);
